        ...
        <div className="w-full bg-white">
            <div className="max-w-contentContainer mx-auto flex items-center py-4">
                <div className="w-2/3 h-full flex items-center justify-center overflow-hidden relative">
                    <img src={product.image} alt="productImg" className="w-[80%] transform-origin-top-left cursor-move duration-500" />
                </div>
                ...
                <div className="w-1/3 h-full flex flex-col gap-2">
                    ...
                    <div className="px-2 py-4 border border-gray-400 rounded-md flex flex-col gap-6">
                        ...
                        <div className="border-b-[1px] border-b-zinc-300 pb-4">
                            ...
                            } className="w-32 h-9 bg-yellow outline outline-1 outline-yellow text-white rounded-full flex items-center justify-center gap-1 hover:bg-white hover:text-black hover:outline hover:outline-1 hover:outline-yellow duration-500">Add to cart</button>
                        </div>
